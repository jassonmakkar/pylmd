...
When looking at another sample dataset with various cell types and sample sources, LMD can be utilized to construct gene modules that highlight cell types, similar cell states across cell types, and sample-specific characteristics.
